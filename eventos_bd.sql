...
START TRANSACTION;
USE `eventos_bd`;
INSERT INTO `eventos_bd`.`usuarios` (`id`, `nome`, `email`, `senha`, `privilegios_id`) VALUES (1, 'Administrador', 'admin@gmail.com', '239b4e2f5b5819d8c9e1cc58bf387ca1cf54b2244514f04205cd1ddc1154b1a2', 1);
